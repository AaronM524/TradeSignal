    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#e8e0d4', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: '"DM Sans", sans-serif' }}>
      ...
      <div style={{ width: '100%', maxWidth: '380px', border: '1px solid rgba(232,224,212,0.12)', background: 'rgba(232,224,212,0.02)', padding: '40px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          <div style={{ fontFamily: '"DM Mono", monospace', fontSize: '10px', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(232,224,212,0.4)', marginBottom: '12px' }}>Get started</div>
          <h1 style={{ fontFamily: '"Playfair Display", serif', fontSize: '28px', fontWeight: 900, letterSpacing: '-0.02em', color: '#e8e0d4', lineHeight: 1.1 }}>Create your<br />account.</h1>
        </div>
        ...
        <form onSubmit={handleSignUp}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div>
              <label className="login-label" htmlFor="repeat-password">Confirm Password</label>
              <input
                id="repeat-password"
                className="login-input"
                type="password"
          ...
          <div style={{ marginTop: '24px', textAlign: 'center', fontFamily: '"DM Sans", sans-serif', fontSize: '13px', color: 'rgba(232,224,212,0.45)' }}>
            ...
            <Link href="/auth/login" style={{ color: '#e8e0d4', textDecoration: 'none', borderBottom: '1px solid rgba(232,224,212,0.3)' }}>
              Log in
            </Link>
          </div>
        </form>
